...
//NOTE - Switch button
const switchBtn = new (0, _switchDefault.default)();
//NOTE - Jiggle button
const jiggleBtn = new (0, _switchDefault.default)({
    attr: "data-jiggle",
...
setTimeout(()=>{
    ...
    <button class="warning spin-btn" data-switch='spin'>
        <span class="spinner">\u{1F355}</span>
    </button>
`;
}, 3000); //!SECTION - Global listener to capitalize on event delegation
...
},{"./switch":"VcwHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"VcwHM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
